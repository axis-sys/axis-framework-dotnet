...
[Collection("AxisCacheMySqlCollection")]
public sealed class AxisCacheMySqlTests(AxisCacheMySqlFixture fixture)
{
    ...
    private ServiceProvider BuildProvider()
    {
        ...
        services.AddAxisCacheMySql(new AxisCacheRepositorySettings
        {
